...
int main(){
	...
	BTNode<int>* b = 
	a->set_leftChild(new BTNode(2)); //o ponteiro "b" passa a apontar para o novo espaco de memoria alocado como filho a esquerda do no "a";
	BTNode<int>* c = 
	a->set_rightChild(new BTNode(3)); //o ponteiro "c" passa a apontar para o novo espaco de memoria alocado como filho a direita do no "a";
